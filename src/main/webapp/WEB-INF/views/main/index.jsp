    ...
    <div class="centerContainer">
        ...
        <div class="slideList">
            <a href="/auction/5" class="list">
                <img class="listImg" src="/assets/롤렉스.png" alt="롤렉스"/>
            </a>
            <a href="/auction/3" class="list">
                <img class="listImg" src="/assets/아이팟.png" alt="아이팟"/>
            </a>
            <a href="/auction/55" class="list">
                <img class="listImg" src="/assets/아디다스.png" alt="아디다스"/>
            </a>
        </div>
        ...
        <div class="slider-container">
            <div class="sliders" id="slideContainer">
                <div class="slider">
                    <a href="/auction/5">
                        <img src="/assets/슬라이드1.png" alt="슬라이드 1"/>
                        <button class="slide-btn">보러가기</button>
                    </a>
                </div>
                <div class="slider">
                    <a href="/auction/3">
                        <img src="/assets/슬라이드2.png" alt="슬라이드 2"/>
                        <button class="slide-btn">보러가기</button>
                    </a>
                </div>
                <div class="slider">
                    <a href="/auction/55">
                        <img src="/assets/슬라이드3.png" alt="슬라이드 3"/>
                        <button class="slide-btn">보러가기</button>
                    </a>
                </div>
            </div>
